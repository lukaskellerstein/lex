...
This repo carries no marker file yet, so all eleven tools report `gated-off`
(checked 2026-09-14). Until `/lint-format-lsp` adds them, match the surrounding
code's formatting by hand.
